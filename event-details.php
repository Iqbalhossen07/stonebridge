                    ...
                    <article class="lg:col-span-2 article-content">
                        <div class="rounded-xl overflow-hidden shadow-soft-2 mb-8" data-aos="fade-up">
                            <img src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=1600&auto=format&fit=crop"
                                alt="Event image" class="w-full h-96" />
                        </div>
                        ...
                        <div class="space-y-6 text-slate-700 text-lg leading-relaxed" data-aos="fade-up">
                            ...
                            <p>Join our expert-led seminar designed for UK employers and HR professionals. This event
                                provides a comprehensive overview of the requirements, application process, and
                                compliance duties associated with the Skilled Worker visa route. Stay informed and
                                ensure your business can attract and retain top international talent.</p>
                    ...
                    <aside class="lg:col-span-1 space-y-8 lg:sticky top-32">
                        <div class="card-premium p-8" data-aos="fade-left">
                            ...
                            <ul class="space-y-4 text-slate-700">
                                <li class="flex items-start gap-3"><svg class="h-6 w-6 text-primary shrink-0"
                                ...
                                <li class="flex items-start gap-3"><svg class="h-6 w-6 text-primary shrink-0"
                                    ...
                                    <div><strong>Time:</strong> 10:00 AM - 1:00 PM</div>
                                </li>
                                <li class="flex items-start gap-3"><svg class="h-6 w-6 text-primary shrink-0"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div><strong>Location:</strong> Aurelia Convention Hall, Dhaka</div>
                                </li>
                            </ul>
                            <div class="mt-8 space-y-3">
                                ...
                                <div class="relative">
                                    <button id="addToCalendarBtn"
                                        class="w-full inline-flex items-center justify-center px-5 py-3 rounded-md border hover:bg-slate-100">
                                        Add to Calendar
                                    ...
                                    <div id="calendarDropdown"
                                        class="absolute bottom-full left-0 w-full mb-2 bg-white rounded-lg shadow-soft-2 border hidden">
                                        <a href="#"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100">Google
                                            Calendar</a>
                                        <a href="#"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100">Outlook
                                            Calendar</a>
                                        <a href="#"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100">Download
                                            .ICS File</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="rounded-xl overflow-hidden shadow-soft-2" data-aos="fade-left" data-aos-delay="100">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.825121415127!2d90.50882501540307!3d23.99999998446864!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3754326166a98297%3A0x231a5f67a3f8d8c!2sNarsingdi!5e0!3m2!1sen!2sbd!4v1694186588661!5m2!1sen!2sbd"
