                ...
                <div class="grid lg:grid-cols-3 gap-12">
                    ...
                    <div class="lg:col-span-2">
                        <div class="grid sm:grid-cols-2 gap-8">
                            <article class="card-premium group" data-aos="fade-up">
                                ...
                                <div class="p-6">
                                    <div class="text-xs text-slate-500 mb-3"><span>Sep 08, 2025</span> &bull; <span>5
                                            min read</span></div>
                                    <h3
                                        class="font-heading text-xl text-slate-800 mb-3 group-hover:text-primary transition-colors">
                                        <a href="#">Designing with depth</a></h3>
                                    <p class="text-slate-600 text-sm leading-relaxed mb-4">How shadows and layering can
                                        transform a flat design into a dynamic experience.</p>
                                    <a href="blog-details.php"
                                        class="font-semibold text-sm text-primary hover:underline">Read More &rarr;</a>
                                </div>
                            </article>
                            <article class="card-premium group" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div class="p-6">
                                    <div class="text-xs text-slate-500 mb-3"><span>Sep 01, 2025</span> &bull; <span>4
                                            min read</span></div>
                                    <h3
                                        class="font-heading text-xl text-slate-800 mb-3 group-hover:text-primary transition-colors">
                                        <a href="#">Invisible gradients</a></h3>
                                    <p class="text-slate-600 text-sm leading-relaxed mb-4">Exploring the subtle art of
                                        using gradients to guide the eye without being noticed.</p>
                                    <a href="blog-details.php"
                                        class="font-semibold text-sm text-primary hover:underline">Read More &rarr;</a>
                                </div>
                            </article>
                        ...
                        <div class="flex justify-center items-center gap-2 mt-16" data-aos="fade-up">
                            <a href="#"
                                class="h-10 w-10 flex items-center justify-center rounded-md text-slate-500 hover:bg-slate-200">&laquo;</a>
                            <a href="#"
                                class="h-10 w-10 flex items-center justify-center rounded-md bg-primary text-white">1</a>
                            <a href="#"
                                class="h-10 w-10 flex items-center justify-center rounded-md text-slate-700 hover:bg-slate-200">2</a>
                            <a href="#"
                                class="h-10 w-10 flex items-center justify-center rounded-md text-slate-700 hover:bg-slate-200">3</a>
                            <a href="#"
                                class="h-10 w-10 flex items-center justify-center rounded-md text-slate-500 hover:bg-slate-200">&raquo;</a>
                        </div>
                    </div>
                    ...
                    <aside class="lg:col-span-1 space-y-8">
                        <div class="card-premium p-6" data-aos="fade-left">
                            <form class="relative">
                                <input type="search" placeholder="Search blog..."
                                    class="w-full px-4 py-2.5 rounded-md bg-slate-100 border-slate-200 focus:ring-primary focus:border-primary" />
                                <button type="submit"
                        ...
                        <div class="card-premium p-8" data-aos="fade-left" data-aos-delay="100">
                            ...
                            <ul class="space-y-4">
                                <li><a href="#"
                                        class="font-semibold text-slate-700 hover:text-primary transition-colors flex justify-between items-center"><span>Web
                                            Design</span> <span class="text-slate-400">(8)</span></a></li>
                                <li><a href="#"
                                        class="font-semibold text-slate-700 hover:text-primary transition-colors flex justify-between items-center"><span>Development</span>
                                        <span class="text-slate-400">(5)</span></a></li>
                                <li><a href="#"
                                        class="font-semibold text-slate-700 hover:text-primary transition-colors flex justify-between items-center"><span>Branding</span>
                                        <span class="text-slate-400">(12)</span></a></li>
                                <li><a href="#"
                                        class="font-semibold text-slate-700 hover:text-primary transition-colors flex justify-between items-center"><span>Marketing</span>
                                        <span class="text-slate-400">(3)</span></a></li>
                            </ul>
                        </div>
                    </aside>
                </div>
