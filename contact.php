...
<body class="bg-white text-slate-900 font-body antialiased selection:bg-primary/20 selection:text-primary">
    ...
    <main>
        <section class="relative pt-40 pb-24 bg-cover bg-center min-h-[400px] flex items-center justify-center"
            style="background-image: url('https://images.unsplash.com/photo-1587560699334-bea93391dcef?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            ...
            <div class="container mx-auto px-6">
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="card-premium p-8 text-center" data-aos="fade-up">
                        <div
                            class="h-16 w-16 mx-auto rounded-full bg-primary/10 text-primary flex items-center justify-center mb-6">
                    ...
                    <div class="card-premium p-8 text-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <a href="mailto:hello@aurelia.com"
                            class="text-slate-600 mt-2 block hover:text-primary">hello@aurelia.com</a>
                    </div>
                    <div class="card-premium p-8 text-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <a href="tel:+8801234567890" class="text-slate-600 mt-2 block hover:text-primary">+880 123 456
                            7890</a>
                    </div>
                </div>
            </div>
                    ...
                    <div data-aos="fade-right">
                        ...
                        <form class="space-y-6">
                            <div class="grid sm:grid-cols-2 gap-6">
                                <div>
                                    <label for="firstName" class="block text-sm font-medium text-slate-700 mb-1">First
                                        Name</label>
                                ...
                                <div>
                                    <label for="lastName" class="block text-sm font-medium text-slate-700 mb-1">Last
                                        Name</label>
                            ...
                            <div>
                                ...
                                <textarea id="message" rows="5" placeholder="Your Message" required
                                    style="display: block; width: 100%; padding: 0.75rem 1rem; border-radius: 0.5rem; border: 1px solid transparent; background-color: #f1f5f9; transition: all 0.2s ease-in-out;"
                                    onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)"></textarea>
                            </div>
                            <div>
