    ...
    <main>
            ...
            <div aria-hidden="true" class="absolute inset-0 z-0 opacity-60">
                <svg class="absolute top-0 left-0 w-full h-auto" viewBox="0 0 1440 900" fill="none"
                    ...
                    <path d="M0 150C0 150 360 300 720 150C1080 0 1440 150 1440 150V900H0V150Z"
                        fill="url(#paint1_linear_wave)" style="mix-blend-mode: overlay" />
                    <defs>
                        <linearGradient id="paint0_linear_wave" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#87550D" stop-opacity="0.05" />
                            <stop offset="1" stop-color="#87550D" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_wave" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
            ...
            <div class="container mx-auto px-6 relative z-10">
                <div class="grid gap-12 lg:grid-cols-2 items-start">
                    ...
                    <div data-aos="fade-left" class="relative flex justify-center lg:justify-end lg:mt-0 mt-12">
                        <div
                            class="absolute top-4 left-0 bg-white/80 backdrop-blur-md p-3 rounded-lg shadow-soft-1 border border-slate-200 flex items-center gap-2 animate-float-slow z-20">
                        ...
                        <div
                            class="absolute bottom-8 right-0 bg-white/80 backdrop-blur-md p-3 rounded-lg shadow-soft-1 border border-slate-200 flex items-center gap-2 animate-float-fast z-20">
                ...
                <div class="grid items-center gap-12 lg:grid-cols-2">
                    ...
                    <div data-aos="fade-right" class="space-y-8 max-w-2xl mx-auto lg:mx-0">
                        <div class="relative w-full rounded-xl overflow-hidden shadow-soft-3 ring-1 ring-black/10">
                            <div id="imageCarousel" class="relative h-[360px] md:h-[400px] w-full">
                                <img src="https://images.unsplash.com/photo-1754531976828-69e42ce4e0d9?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                    alt="About gallery image 3"
                                    class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ease-in-out carousel-image"
                                    alt="About gallery image 1"
                                    class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ease-in-out carousel-image active" />
                                <img src="https://images.unsplash.com/photo-1601513042740-3f9041642307?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                    alt="About gallery image 2"
                                    class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ease-in-out carousel-image" />
                                <img src="https://images.unsplash.com/photo-1622675363311-3e1904dc1885?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                    alt="About gallery image 3"
                                    class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ease-in-out carousel-image" />

                                <button aria-label="Previous image"
                                    class="carousel-arrow absolute left-4 top-1/2 -translate-y-1/2 bg-white/70 backdrop-blur-md rounded-full p-2 text-slate-800 hover:bg-white transition-colors duration-300 shadow-md z-10"
                                ...
                                <button aria-label="Next image"
                                    class="carousel-arrow absolute right-4 top-1/2 -translate-y-1/2 bg-white/70 backdrop-blur-md rounded-full p-2 text-slate-800 hover:bg-white transition-colors duration-300 shadow-md z-10"
                                    onclick="changeSlide(1)">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div id="carouselIndicators"
                                ...
                                <button aria-label="Slide 1"
                                    class="carousel-indicator h-3 w-3 rounded-full bg-slate-300 hover:bg-slate-400 active-indicator"></button>
                                <button aria-label="Slide 2"
                                    class="carousel-indicator h-3 w-3 rounded-full bg-slate-300 hover:bg-slate-400"></button>
                    ...
                    <div data-aos="fade-left" class="space-y-6 lg:text-left text-center shadow-sm p-4">
                        ...
                        <p class="text-slate-700 max-w-prose mx-auto lg:mx-0 text-lg leading-relaxed text-justify">
                            ...
                            all aspects of UK Immigration Law, including visa applications and appeals.
                        </p>
                ...
                <div id="services-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-8xl mx-auto">
                    ...
                    <div class="card-premium p-6" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Sponsorship Licence.webp" alt="Sponsorship Licence Icon"
                    ...
                    <div class="card-premium p-6" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Immigration Compliance.webp" alt="Immigration Compliance Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2">
                    ...
                    <div class="card-premium p-6" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Skilled Worker.webp" alt="Skilled Worker Visas Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2">
                    ...
                    <div class="card-premium p-6" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Temporary.webp" alt="Sponsorship Licence Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2">
                    ...
                    <div class="card-premium p-6" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Partner and family.webp" alt="Immigration Compliance Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2">
                    ...
                    <div class="card-premium p-6" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Global Business.webp" alt="Skilled Worker Visas Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2">
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Standard Visitor Visa.webp" alt="Standard Visitor Visa Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Study Visas.webp" alt="Study Visas Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Business Visas.webp" alt="Business Visas Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Scale Up Visa.webp" alt="Scale Up Visa Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/UKVI Compliant HR Software.webp" alt="UKVI HR Software Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/EU Settlement Scheme.webp" alt="EU Settlement Scheme Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/UK Settlement Scheme.webp" alt="UK Settlement Scheme Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/British Citizenship.webp" alt="British Citizenship Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
                    ...
                    <div class="card-premium p-6 hidden" data-aos="fade-up">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="h-16 w-16 bg-orange-100 rounded-lg flex items-center justify-center p-2 shadow-sm ring-1 ring-orange-200 shrink-0">
                                <img src="img/Immigration Appeals.webp" alt="Immigration Appeals Icon"
                                    class="h-full w-full object-contain" />
                            </div>
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-center gap-2"><svg class="h-5 w-5 text-primary shrink-0"
        ...
        <section id="gallery" class="relative py-24 bg-slate-50/50 overflow-hidden">
            ...
            <div aria-hidden="true" class="absolute inset-0 z-0 opacity-60">
                <svg class="absolute top-0 left-0 w-full h-auto" viewBox="0 0 1440 900" fill="none"
                    xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
                    <path d="M0 200C0 200 360 400 720 200C1080 0 1440 200 1440 200V900H0V200Z"
                        fill="url(#paint0_linear_wave_gallery)" />
                    <path d="M0 150C0 150 360 300 720 150C1080 0 1440 150 1440 150V900H0V150Z"
                        fill="url(#paint1_linear_wave_gallery)" style="mix-blend-mode: overlay" />
                    <defs>
                        <linearGradient id="paint0_linear_wave_gallery" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#87550D" stop-opacity="0.05" />
                            <stop offset="1" stop-color="#87550D" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_wave_gallery" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#87550D" stop-opacity="0.1" />
                            <stop offset="1" stop-color="#87550D" stop-opacity="0" />
                        </linearGradient>
        ...
        <section id="team" class="relative py-24 bg-slate-50/50 overflow-hidden">
            ...
            <div aria-hidden="true" class="absolute inset-0 z-0 opacity-60">
                <svg class="absolute top-0 left-0 w-full h-auto" viewBox="0 0 1440 900" fill="none"
                    xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
                    <path d="M0 200C0 200 360 400 720 200C1080 0 1440 200 1440 200V900H0V200Z"
                        fill="url(#paint0_linear_wave_team)" />
                    <path d="M0 150C0 150 360 300 720 150C1080 0 1440 150 1440 150V900H0V150Z"
                        fill="url(#paint1_linear_wave_team)" style="mix-blend-mode: overlay" />
                    <defs>
                        <linearGradient id="paint0_linear_wave_team" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#87550D" stop-opacity="0.05" />
                            <stop offset="1" stop-color="#87550D" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_wave_team" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#87550D" stop-opacity="0.1" />
                            <stop offset="1" stop-color="#87550D" stop-opacity="0" />
                        </linearGradient>
            ...
            <div class="container mx-auto px-6 relative z-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="team-card group" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-card-inner">
                            <div class="relative overflow-hidden rounded-t-lg">
                                <img src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=800&auto=format&fit=crop"
                                    alt="Team Member 1"
                            ...
                            <div class="p-5 text-center">
                                ...
                                <a href="team-details.php"
                                    class="font-semibold text-sm text-primary hover:underline">View Profile &rarr;</a>
                            </div>
                        </div>
                        <div class="social-panel">
                            <a href="#" aria-label="Twitter" class="social-link"><svg viewBox="0 0 24 24"
                            ...
                            <a href="#" aria-label="LinkedIn" class="social-link"><svg viewBox="0 0 24 24"
                                    class="h-6 w-6" fill="currentColor">
                                    <path
                    ...
                    <div class="team-card group" data-aos="fade-up" data-aos-delay="400">
                        <div class="team-card-inner">
                            <div class="relative overflow-hidden rounded-t-lg">
                                <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=800&auto=format&fit=crop"
                                    alt="Team Member 2"
                                    class="w-full h-72 object-cover transition-transform duration-300 group-hover:scale-105" />
                            </div>
                            <div class="p-5 text-center">
        ...
        <section id="testimonials" class="relative py-24 bg-slate-50/50 overflow-hidden">
            ...
            <div class="container mx-auto px-6 relative z-10">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h3 class="font-heading text-lg font-semibold text-primary tracking-widest uppercase mb-2"
                        data-aos="fade-up">Hear From Our Happy Patients</h3>
                    <h2 class="font-heading text-2xl md:text-4xl text-slate-900 leading-tight" data-aos="fade-up"
                        data-aos-delay="100">What Our Patients Are Saying</h2>
                </div>
                ...
                <div class="relative max-w-6xl mx-auto">
                        ...
                        <div id="testimonialCarousel" class="flex transition-transform duration-500 ease-in-out">
                                    ...
                                    <div class="flex items-center justify-between mt-auto">
                                        <div class="flex items-center">
                                            <img src="https://randomuser.me/api/portraits/men/32.jpg"
                                                alt="Sheldon Jackson" class="w-12 h-12 rounded-full object-cover mr-4">
                                            <div>
                                        ...
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg"
                                            alt="Google Logo" class="h-8 opacity-70">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="testimonial-card flex-shrink-0 w-full md:w-1/2 p-4">
                                <div class="h-full bg-white rounded-xl shadow-lg p-8 flex flex-col justify-between">
                                    ...
                                    <div class="flex items-center justify-between mt-auto">
                                        <div class="flex items-center">
                                            <img src="https://randomuser.me/api/portraits/men/44.jpg" alt="Jason Doe"
                                    ...
                                    <div class="flex items-center justify-between mt-auto">
                                        <div class="flex items-center">
                                            <img src="https://randomuser.me/api/portraits/women/80.jpg"
                                                alt="Emily White" class="w-12 h-12 rounded-full object-cover mr-4">
                                            <div>
                    ...
                    <button id="prevTestimonial"
                        class="absolute top-1/2 left-0 transform -translate-y-1/2 bg-slate-800 text-white p-3 rounded-full shadow-lg hover:bg-slate-700 transition hidden md:block">
                    ...
                    <button id="nextTestimonial"
                        class="absolute top-1/2 right-0 transform -translate-y-1/2 bg-slate-800 text-white p-3 rounded-full shadow-lg hover:bg-slate-700 transition hidden md:block">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
        ...
        <section id="blog" class="relative py-24 bg-slate-50/50 overflow-hidden">
            ...
            <div aria-hidden="true" class="absolute inset-0 z-0 opacity-60">
                <svg class="absolute top-0 left-0 w-full h-auto" viewBox="0 0 1440 900" fill="none"
                    xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
                    <path d="M0 200C0 200 360 400 720 200C1080 0 1440 200 1440 200V900H0V200Z"
                        fill="url(#paint0_linear_wave_blog)" />
                    <path d="M0 150C0 150 360 300 720 150C1080 0 1440 150 1440 150V900H0V150Z"
                        fill="url(#paint1_linear_wave_blog)" style="mix-blend-mode: overlay" />
                    <defs>
                        <linearGradient id="paint0_linear_wave_blog" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#87550D" stop-opacity="0.05" />
                            <stop offset="1" stop-color="#87550D" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_wave_blog" x1="720" y1="0" x2="720" y2="900"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#87550D" stop-opacity="0.1" />
                            <stop offset="1" stop-color="#87550D" stop-opacity="0" />
                        </linearGradient>
            ...
            <div class="container mx-auto px-6 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <article class="card-premium group" data-aos="fade-up" data-aos-delay="300">
                        <div class="relative overflow-hidden rounded-t-lg">
                            <img src="https://images.unsplash.com/photo-1624555130581-1d9cca783bc0?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fHw%3D"
                        ...
                        <div class="p-6">
                            ...
                            <h3
                                class="font-heading text-xl text-slate-800 mb-3 group-hover:text-primary transition-colors">
                                <a href="#">Designing with depth</a>
                            </h3>
                            <p class="text-slate-600 text-sm leading-relaxed mb-4">
                                How shadows and layering can transform a flat design into a dynamic experience.
                            </p>
                            <a href="blog-details.php" class="font-semibold text-sm text-primary hover:underline">Read
                                More &rarr;</a>
                        </div>
                    </article>
                    ...
                    <article class="card-premium group" data-aos="fade-up" data-aos-delay="400">
                        <div class="relative overflow-hidden rounded-t-lg">
                            <img src="https://images.unsplash.com/photo-1681949287382-052ea3954a51?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDl8fHxlbnwwfHx8fHw%3D"
                    ...
                    <article class="card-premium group" data-aos="fade-up" data-aos-delay="500">
                        <div class="relative overflow-hidden rounded-t-lg">
                            <img src="https://images.unsplash.com/photo-1739298061707-cefee19941b7?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDEwfHx8ZW58MHx8fHx8"
                    ...
                    <article class="card-premium group" data-aos="fade-up" data-aos-delay="600">
                        <div class="relative overflow-hidden rounded-t-lg">
                            <img src="https://images.unsplash.com/photo-1676277758170-2cb1c5d94a9f?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE4fHx8ZW58MHx8fHx8"
                                alt="Blog post image 4"
                                class="w-full h-56 object-cover transition-transform duration-500 group-hover:scale-105" />
                        </div>
                        <div class="p-6">
                            <div class="text-xs text-slate-500 mb-3">
