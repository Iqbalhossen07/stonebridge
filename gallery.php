            ...
            <div class="container mx-auto px-6 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        ...
                        <img src="img/g1.jpeg" alt="Gallery Image"
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        ...
                        <img src="img/g2.jpeg" alt="Gallery Image"
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div
                            class="absolute inset-0 bg-primary/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        ...
                        <img src="img/g3.jpeg" alt="Gallery Image"
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div
                            class="absolute inset-0 bg-primary/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        data-aos="fade-up" data-aos-delay="100">
                        <img src="img/g4.jpeg" alt="Gallery Image"
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div
                            class="absolute inset-0 bg-primary/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        data-aos="fade-up" data-aos-delay="200">
                        <img src="img/g5.jpeg" alt="Gallery Image"
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div
                            class="absolute inset-0 bg-primary/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        data-aos="fade-up" data-aos-delay="300">
                        <img src="img/g6.jpeg" alt="Gallery Image"
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div
                            class="absolute inset-0 bg-primary/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        data-aos="fade-up" data-aos-delay="300">
                        <img src="img/g7.jpeg" alt="Gallery Image"
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div
                            class="absolute inset-0 bg-primary/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="#" class="group relative block w-full h-80 overflow-hidden rounded-xl shadow-soft-2"
                        data-aos="fade-up" data-aos-delay="300">
                        <img src="img/g8.jpeg" alt="Gallery Image"
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div
                            class="absolute inset-0 bg-primary/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
