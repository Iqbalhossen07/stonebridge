                ...
                <div class="hidden lg:flex flex-col gap-1 items-start">
                    <div class="flex items-center gap-6">
                        <a href="mailto:info@stonebridgelegal.co.uk"
                            class="flex items-center gap-2 text-sm text-slate-600 hover:text-primary transition-colors">
    ...
    <div id="navWrap" class="bg-primary shadow-md">
        <nav class="hidden md:flex container mx-auto items-center justify-center py-2">
            <ul class="flex items-center gap-6 font-semibold relative">
                <li><a href="index.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Home</a></li>
                <li class="relative group">
                    <a href="about.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors flex items-center gap-1">
                        About <svg class="h-4 w-4 transition-transform duration-300 group-hover:rotate-180" fill="none"
                ...
                <li class="group static">
                    <a href="services.html"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors flex items-center gap-1">
                        Services <svg class="h-4 w-4 transition-transform duration-300 group-hover:rotate-180"
                    ...
                    <div
                        class="mega-menu absolute top-full left-1/2 -translate-x-1/2 w-screen max-w-7xl bg-white shadow-soft-2 rounded-lg border mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-20">
                ...
                <li><a href="self-sponsorship.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Self-Sponsorship</a>
                </li>
                <li><a href="psw.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">PSW</a></li>
                <li><a href="asylum.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Asylum</a></li>
                <li><a href="sponsor-checker.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Sponsor
                        Checker</a></li>
                <li><a href="skilled-worker-occupations.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Eligible
                        Occupation</a></li>
                <li><a href="gallery.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Gallery </a>
                </li>
                <li><a href="video.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Video </a>
                </li>

                <li><a href="events.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Events </a></li>
                <li><a href="blog.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Blog </a></li>

                <li><a href="resources.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Resources</a>
                </li>
                <li><a href="contact.php"
                        class="text-sm tracking-wide text-white hover:text-amber-300 transition-colors">Contact </a>
                </li>
        ...
        <div id="mobileMenu"
            class="hidden md:hidden border-t bg-white/95 backdrop-blur-xl max-h-[calc(100vh-80px)] overflow-y-auto">
            <div class="container mx-auto px-6 py-4">
                <ul class="grid gap-3">
                    <li><a href="index.php" class="block px-3 py-2 rounded-md hover:bg-slate-100">Home</a></li>
                    <li class="mobile-accordion">
                        <button
                            class="mobile-accordion-trigger w-full flex justify-between items-center px-3 py-2 rounded-md hover:bg-slate-100"><span
                                class="font-semibold">About</span><svg class="h-4 w-4 transition-transform duration-300"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="mobile-accordion">
                        <button
                            class="mobile-accordion-trigger w-full flex justify-between items-center px-3 py-2 rounded-md hover:bg-slate-100"><span
                                class="font-semibold">Services</span><svg
                        ...
                        <div class="mobile-accordion-content pl-4 pt-2">
                            <ul class="grid gap-1 text-slate-700">
                                <li class="mobile-sub-accordion"><button
                                    ...
                                    <div class="mobile-sub-accordion-content">
                                        <ul class="text-sm">
                                            <li><a href="#">Sponsor Licence Application</a></li>
                                            <li><a href="#">Sponsor Licence Renewal</a></li>
                                            <li><a href="#">Sponsor Licence Suspension</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="mobile-sub-accordion"><button
                                    ...
                                    <div class="mobile-sub-accordion-content">
                                        <ul class="text-sm">
                                            <li><a href="#">Civil Penalty</a></li>
                                            <li><a href="#">HO Compliance Visit</a></li>
                                            <li><a href="#">Right to Work Check</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="mobile-sub-accordion"><button
                                    ...
                                    <div class="mobile-sub-accordion-content">
                                        <ul class="text-sm">
                                            <li><a href="#">Skilled Worker Visa</a></li>
                                            <li><a href="#">Minister of Religion Visa</a></li>
                                            <li><a href="#">Health Care Visa</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="mobile-sub-accordion"><button
                                        class="mobile-sub-accordion-trigger w-full flex justify-between items-center py-1 text-left font-medium"><span>Temporary
                                            (Tier 5) Visas</span><svg class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 9l-7 7-7-7"></path>
                                        </svg></button>
                                    <div class="mobile-sub-accordion-content">
                                        <ul class="text-sm">
                                            <li><a href="#">Religious Worker Visa</a></li>
                                            <li><a href="#">Creative Worker Visa</a></li>
                                            <li><a href="#">Charity Worker Visa</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="mobile-sub-accordion"><button
                                        class="mobile-sub-accordion-trigger w-full flex justify-between items-center py-1 text-left font-medium"><span>Partner
                                            and family Visas</span><svg class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 9l-7 7-7-7"></path>
                                        </svg></button>
                                    <div class="mobile-sub-accordion-content">
                                        <ul class="text-sm">
                                            <li><a href="#">Spouse Visa</a></li>
                                            <li><a href="#">Dependent Visa</a></li>
                                            <li><a href="#">Unmarried Partner Visa</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li><a href="services.php" class="block py-1 mt-2 font-semibold text-primary">View All
                                        Services &rarr;</a></li>
                            </ul>
                        </div>
                    </li>
                    <li><a href="self-sponsorship.php"
                            class="block px-3 py-2 rounded-md hover:bg-slate-100">Self-Sponsorship</a></li>
                    ...
                    <li><a href="sponsor-checker.php" class="block px-3 py-2 rounded-md hover:bg-slate-100">Sponsor
                            Checker</a></li>
                    <li><a href="skilled-worker-occupations.php"
                            class="block px-3 py-2 rounded-md hover:bg-slate-100">Eligible Occupation</a></li>
                    <li><a href="gallery.php"
                            class="block px-3 py-2 rounded-md hover:bg-slate-100">Gallery </a></li>
                    <li><a href="video.php"
                            class="block px-3 py-2 rounded-md hover:bg-slate-100">Video </a></li>
                    <li><a href="events.php"
                            class="block px-3 py-2 rounded-md hover:bg-slate-100">Events </a></li>
                    <li><a href="blog.php"
                            class="block px-3 py-2 rounded-md hover:bg-slate-100">Blog </a></li>
