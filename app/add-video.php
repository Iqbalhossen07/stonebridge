    ...
    <div class="flex h-screen bg-secondary overflow-hidden">
        <aside id="desktop-sidebar" class="w-64 flex-shrink-0 bg-gray-900 text-white hidden lg:flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="#" class="sidebar-link active flex items-center gap-3 px-6 py-3 rounded-lg"><i class="fas fa-video w-5"></i><span>Videos</span></a>
        ...
        <div class="flex-1 flex flex-col overflow-y-auto relative">
            <header class="bg-white shadow-soft-1 sticky top-0 z-20">
                <div class="container mx-auto px-6 py-3 flex items-center justify-between">
                    <h1 class="font-heading text-xl md:text-2xl font-bold text-primary">Add New Video</h1>
            ...
            <main class="flex-1 p-6">
                <div class="bg-white rounded-xl shadow-soft-1 p-6 lg:p-8 max-w-4xl mx-auto">
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="video-title" class="block text-sm font-medium text-slate-700 mb-2">Video Title</label>
                            <input type="text" id="video-title" class="input-final" placeholder="Enter video title...">
                        </div>

                        <div>
                            <label for="video-link" class="block text-sm font-medium text-slate-700 mb-2">YouTube Video Link</label>
                            <input type="url" id="video-link" class="input-final" placeholder="e.g., https://www.youtube.com/watch?v=5eBoRi-362E">
                            <p class="mt-2 text-xs text-slate-500">Paste the full YouTube video URL here. The thumbnail will be generated automatically.</p>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                             <div>
                                <label for="video-duration" class="block text-sm font-medium text-slate-700 mb-2">Duration</label>
                                <input type="text" id="video-duration" class="input-final" placeholder="e.g., 12:45">
                            </div>
                            <div>
                                <label for="publish-date" class="block text-sm font-medium text-slate-700 mb-2">Publish Date</label>
                                <input type="date" id="publish-date" class="input-final">
                            </div>
                        </div>

                        <div>
                            <label for="video-description" class="block text-sm font-medium text-slate-700 mb-2">Description</label>
                            <textarea id="video-description" rows="4" class="input-final" placeholder="Write a short description for the video..."></textarea>
                        </div>
                        ...
                        <div class="pt-5 flex items-center justify-end gap-3">
                            ...
                            <button type="submit" class="bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300">Publish Video</button>
                        </div>
                    </form>
                </div>
            </main>
