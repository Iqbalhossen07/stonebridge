...
<head>
    ...
    <title>View Event - Dashboard</title>
        ...
        <div class="flex-1 flex flex-col overflow-y-auto relative">
            <header class="bg-white shadow-soft-1 sticky top-0 z-20">
                <div class="container mx-auto px-6 py-3 flex items-center justify-between">
                    <h1 class="font-heading text-xl md:text-2xl font-bold text-primary">Event Details</h1>
            ...
            <main class="flex-1 p-6">
                <div class="flex justify-between items-center mb-6">
                    <a href="manage-events.html" class="text-primary hover:text-primary-dark font-medium flex items-center gap-2">
                ...
                <div class="bg-white rounded-xl shadow-soft-1 p-6 lg:p-8">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div class="lg:col-span-2">
                            <img src="https://images.unsplash.com/photo-1505373877841-8c25f7d46678?q=80&w=2070&auto=format&fit=crop" alt="Event Image" class="w-full h-auto rounded-lg shadow-md mb-6">
                            <h2 class="font-heading text-3xl font-bold text-slate-800">Free Legal Advice Webinar</h2>
                            <div class="prose max-w-none mt-4 text-slate-600">
                                <p>Join our free webinar where our expert solicitors will discuss the latest changes in UK immigration law. This session is perfect for students, professionals, and families looking for clear and reliable legal advice.</p>
                                <p>We will cover key topics such as the Skilled Worker visa, the EU Settlement Scheme, and the requirements for indefinite leave to remain. There will be a live Q&A session at the end where you can ask our legal experts your questions directly.</p>
                            </div>
                        </div>

                        <div class="space-y-6">
                            <div class="bg-slate-50 rounded-lg p-4">
                                <h3 class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-3">Status</h3>
                                <span class="bg-blue-100 text-blue-800 text-sm font-medium px-3 py-1 rounded-full">Upcoming</span>
                            </div>
                             <div class="bg-slate-50 rounded-lg p-4">
                                <h3 class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-3">Date & Time</h3>
                                <div class="space-y-2 text-slate-700">
                                    <p class="flex items-center gap-3"><i class="fas fa-calendar-alt w-4 text-primary/70"></i> <span>Sep 25, 2025</span></p>
                                    <p class="flex items-center gap-3"><i class="far fa-clock w-4 text-primary/70"></i> <span>03:00 PM - 05:00 PM</span></p>
                                </div>
                            </div>
                            <div class="bg-slate-50 rounded-lg p-4">
                                <h3 class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-3">Location</h3>
                                <p class="flex items-center gap-3 text-slate-700"><i class="fas fa-map-marker-alt w-4 text-primary/70"></i> <span>Online (Zoom)</span></p>
                            </div>
                        </div>
                    </div>
                </div>
