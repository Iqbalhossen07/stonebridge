...
<head>
    ...
    <title>View Testimonial - Dashboard</title>
        ...
        <div class="flex-1 flex flex-col overflow-y-auto relative">
            <header class="bg-white shadow-soft-1 sticky top-0 z-20">
                <div class="container mx-auto px-6 py-3 flex items-center justify-between">
                    <h1 class="font-heading text-xl md:text-2xl font-bold text-primary">View Testimonial</h1>
            ...
            <main class="flex-1 p-6">
                <div class="flex justify-between items-center mb-6">
                    <a href="manage-testimonials.html" class="text-primary hover:text-primary-dark font-medium flex items-center gap-2">
                ...
                <div class="bg-white rounded-xl shadow-soft-1 p-6 lg:p-8">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div class="lg:col-span-2">
                            ...
                            <blockquote class="prose prose-xl max-w-none text-slate-800 border-l-4 border-primary pl-6 italic">
                                "Sonjoy dada you are such a very nice person. Who help me not only in my legal issues also help me to control my emotions, how to deal with my mental situation. Dada love you."
                            </blockquote>
                        </div>

                        <div class="space-y-6">
                            <div>
                                <h3 class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">Author Details</h3>
                                <div class="flex items-center gap-4">
                                    <img src="https://randomuser.me/api/portraits/men/32.jpg" class="w-20 h-20 rounded-full object-cover" alt="Author">
                                    <div>
                                        <p class="font-heading font-bold text-lg text-slate-900">Sheldon Jackson</p>
                            ...
                            <div class="border-t border-slate-200 pt-6">
                                ...
                                <span class="bg-green-100 text-green-800 text-sm font-medium px-3 py-1 rounded-full">Published</span>
                            </div>
                        </div>
                    </div>
                </div>
