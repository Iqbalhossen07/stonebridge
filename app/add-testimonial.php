        ...
        <div class="flex-1 flex flex-col overflow-y-auto relative">
            <header class="bg-white shadow-soft-1 sticky top-0 z-20">
                <div class="container mx-auto px-6 py-3 flex items-center justify-between">
                    <h1 class="font-heading text-xl md:text-2xl font-bold text-primary">Add New Testimonial</h1>
                ...
                <div class="bg-white rounded-xl shadow-soft-1 p-6 lg:p-8">
                    <form action="#" method="POST" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="author-name" class="block text-sm font-medium text-slate-700 mb-2">Author's Name</label>
                                <input type="text" id="author-name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm " placeholder="e.g., Sheldon Jackson">
                            </div>
                            <div>
                                <label for="author-designation" class="block text-sm font-medium text-slate-700 mb-2">Author's Designation</label>
                                <input type="text" id="author-designation" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm" placeholder="e.g., Software Engineer">
                            </div>
                        </div>
                        ...
                        <div>
                            <label for="testimonial-content" class="block text-sm font-medium text-slate-700 mb-2">Testimonial Content</label>
                            <textarea id="testimonial-content" rows="6" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm" placeholder="Write the testimonial here..."></textarea>
                        </div>
                        ...
                        <div class="pt-5 flex items-center justify-end gap-3">
                            ...
                            <button type="submit" class="bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300">Add Testimonial</button>
                        </div>
                    </form>
                </div>
            </main>
