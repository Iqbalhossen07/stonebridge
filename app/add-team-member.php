...
<head>
    ...
    <title>Add New Member - Dashboard</title>
        ...
        <div class="flex-1 flex flex-col overflow-y-auto relative">
            <header class="bg-white shadow-soft-1 sticky top-0 z-20">
                <div class="container mx-auto px-6 py-3 flex items-center justify-between">
                    <h1 class="font-heading text-xl md:text-2xl font-bold text-primary">Add New Team Member</h1>
                ...
                <div class="bg-white rounded-xl shadow-soft-1 p-6 lg:p-8">
                    <form action="#" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            <div>
                                <label for="member-name" class="block text-sm font-medium text-slate-700 mb-2">Full Name</label>
                                <input type="text" id="member-name" class="custom-input-clear" placeholder="Enter member's full name">
                            </div>
                            <div>
                                <label for="member-role" class="block text-sm font-medium text-slate-700 mb-2">Role / Designation</label>
                                <input type="text" id="member-role" class="custom-input-clear" placeholder="e.g., Solicitor, Barrister & FCILEX">
                            </div>
                            <div>
                                <label for="member-bio" class="block text-sm font-medium text-slate-700 mb-2">Short Bio</label>
                                <textarea id="member-bio" rows="6" class="custom-input-clear" placeholder="Write a short introduction about the team member..."></textarea>
                            </div>
                             <div class="space-y-4">
                                <label class="block text-sm font-medium text-slate-700">Social Links</label>
                                <div class="relative"><i class="fab fa-linkedin-in absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i><input type="url" class="custom-input-clear pl-10" placeholder="LinkedIn URL"></div>
                                <div class="relative"><i class="fab fa-twitter absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i><input type="url" class="custom-input-clear pl-10" placeholder="Twitter URL"></div>
                                <div class="relative"><i class="fas fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i><input type="email" class="custom-input-clear pl-10" placeholder="Email Address"></div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border-t border-slate-200 pt-6 flex items-center justify-end gap-3">
                                <button type="button" class="bg-slate-200 hover:bg-slate-300 text-slate-800 font-bold py-2 px-4 rounded-lg transition-colors duration-300">Cancel</button>
                                <button type="submit" class="bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300">Add Member</button>
                            </div>
                        </div>
                    </form>
                </div>
