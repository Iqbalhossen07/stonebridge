...
<!-- <div class="fixed bottom-8 right-8 z-50">
  <div class="flex flex-col gap-4">
    ...
    <a href="#" aria-label="Chat on WhatsApp" target="_blank" rel="noopener noreferrer" 
       class="w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transform hover:scale-110 transition-transform duration-200 ease-in-out"
       style="background-color: #25D366;">
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
        <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.451-4.437-9.884-9.888-9.884-5.452 0-9.885 4.434-9.888 9.884.001 2.228.651 4.39 1.849 6.22l-1.072 3.912 3.912-1.074z"/>
      </svg>
    </a>

    <a href="#" aria-label="Follow on Facebook" target="_blank" rel="noopener noreferrer"
       class="w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transform hover:scale-110 transition-transform duration-200 ease-in-out"
    ...
    <a href="#" aria-label="Follow on Twitter" target="_blank" rel="noopener noreferrer"
       class="w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transform hover:scale-110 transition-transform duration-200 ease-in-out"
    ...
    <a href="#" aria-label="Subscribe on YouTube" target="_blank" rel="noopener noreferrer"
       class="w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transform hover:scale-110 transition-transform duration-200 ease-in-out"
